...
//  let mail="manimani19508@gmail.com";
//  let letter=""


// let string=mail.match(/[a-z]/g).join("")
//          console.log("letters",letter);

//          let special=mail.match(/\W/g).join("");
//          console.log("splcharacter",special);

//          let number=mail.match(/\d/g).join("");
//          console.log("number",number)



// var mail="manimani19508@gmail.com";
// var num=mail.match(/\d/g).join("");
//          console.log(num);
//     var num1=num     
//    var overall=0;    
//    while(num1<0){
